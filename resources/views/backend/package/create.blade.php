        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('package.store') }}" method="post" class="needs-validation" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="ckeditor form-control" id="validationCustom3" name="description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-9 col-md-8">
                                        <div class="checkbox checkbox-primary">
                                            <input id="checkbox-primary-2" type="checkbox" data-original-title=""
                                                title="" name="status">
                                            <label for="checkbox-primary-2">اظهار الباقة </label>
                                        </div>
                                    </div>
                                </div>
